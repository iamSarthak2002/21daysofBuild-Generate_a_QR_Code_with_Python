...
![QR example](https://github.com/iamSarthak2002/21daysofBuild-Generate_a_QR_Code_with_Python/blob/main/qr_code.png)
...
First, we want a link that we want to showcase. Let's use a [classic YouTube video](https://www.youtube.com/watch?v=5gTToFIZp-g).
...
- [Solution on GitHub](https://github.com/iamSarthak2002/21daysofBuild-Generate_a_QR_Code_with_Python/blob/main/qr_code.py)
